...
use surrealdb::sql::{Number, Object, Thing};
...
// fn to_custom_value<T: Into<CustomValue>>(value: T) -> CustomValue {
//     value.into()
// }

// impl From<&str> for CustomValue {
//     fn from(s: &str) -> Self {
//         CustomValue::String(s.to_string())
//     }
// }
...
// impl From<bool> for CustomValue {
//     fn from(b: bool) -> Self {
//         CustomValue::Bool(b)
//     }
// }

// impl From<i32> for CustomValue {
//     fn from(n: i32) -> Self {
//         CustomValue::Number(n as f64)
//     }
// }

// impl From<f64> for CustomValue {
//     fn from(n: f64) -> Self {
...
//     // Null
//     (null) => {
//         CustomValue::Surreal(SurValue::None)
//     };

//     // Array
//     ([ $($element:tt),* ]) => {
//         CustomValue::Array(vec![ $( jsonc!($element) ),* ])
//     };

//     // Object with colon syntax
//     ({ $($key:tt : $value:tt),* }) => {
//         CustomValue::Object(HashMap::from([
//             $( (stringify!($key).to_string(), jsonc!($value)) ),*
//         ]))
//     };

//     // Object with arrow syntax
//     ({ $($key:tt => $value:tt),* }) => {
//         CustomValue::Object(HashMap::from([
//             $( (stringify!($key).to_string(), jsonc!($value)) ),*
//         ]))
...
//     // Other values (strings, numbers, booleans)
//     ($other:expr) => {
//         to_custom_value($other)
//     };
// }
...
//             Value::Number(n) => CustomValue::Number(n.as_f64().unwrap_or_default()),
...
//             CustomValue::Number(n) => serializer.serialize_f64(*n),
...
// impl CustomValue {
//     fn as_object(&self) -> Option<&HashMap<String, CustomValue>> {
//         match self {
//             CustomValue::Object(map) => Some(map),
//             _ => None,
//         }
//     }

//     fn as_object_mut(&mut self) -> Option<&mut HashMap<String, CustomValue>> {
//         match self {
//             CustomValue::Object(map) => Some(map),
//             _ => None,
//         }
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let author_bio_template = ComponentTemplate {
        ...
        default_data: HashMap::from([
            ("name".to_string(), Value::Number(Number::from(1))),
            (
                "bio".to_string(),
                Value::Object(Object::from(HashMap::from([
                    ("text".to_string(), Value::Strand(surrealdb::sql::Strand("Default bio".to_string()))),
                    ("is_markdown".to_string(), Value::Bool(true)),
                ]))),
            )
            // (
            //     "image_url".to_string(),
            //     jsonc!("https://example.com/default.jpg"),
            // ),
            // (
            //     "social_links".to_string(),
            //     jsonc!([{platform: "Twitter", url: "https://twitter.com/default"}]),
            // ),
        ]),
...
//         "header",
//         HashMap::from([
//             ("text".to_string(), jsonc!("My First Blog Post")),
//             ("level".to_string(), jsonc!(1)),
//         ]),
//     );
//     doc.add_block(
//         "paragraph",
//         HashMap::from([(
//             "text".to_string(),
//             jsonc!("This is the content of my first blog post."),
//         )]),
//     );

//     // // Add a linked authorBio block
  let author_bio_data: HashMap<String, Value> = HashMap::from([
        // ("name".to_string(), jsonc!("John Doe")),
        // ("bio".to_string(), jsonc!("Default bio for John Doe")),
        // ("image_url".to_string(), jsonc!("https://example.com/johndoe.jpg")),
        // ("social_links".to_string(), jsonc!([
        //     { platform => "Twitter", url => "https://twitter.com/johndoe" },
        //     { platform => "LinkedIn", url => "https://linkedin.com/in/johndoe" }
        // ])),
        // ("display_config".to_string(), jsonc!({
        //     name => true,
        //     bio => true,
        //     image_url => false,
        //     social_links => true
        // })),
        // ("is_attached".to_string(), jsonc!(true)),
        ("template_id".to_string(), Value::Thing(Thing::from(("component_templates", "ct-001"))).into()),
    ]);
    ...
    println!("Updated document with local override: {:?}", retrieved_doc);
